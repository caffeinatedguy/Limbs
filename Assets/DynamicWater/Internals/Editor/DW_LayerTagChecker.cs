...
public class DW_LayerTagChecker : MonoBehaviour {
    public static readonly string[] kRequiredTags = {
        "DynamicWater", 
    ...
    public static readonly string[] kRequiredLayers = {
        "DynamicWaterPlaneCollider"
    };
    ...
    public static void ShowMissingTagsAndLayersDialog() {
        ShowMissingTagsAndLayersDialog(kRequiredTags, kRequiredLayers);
    }
